 ...
 * Features glassmorphism effect and blurred contact info until unlocked
 */
					...
					{!isUnlocked ? (
						<div className="space-y-4 mb-6">
							<div>
								...
								<div className="bg-white/5 backdrop-blur-sm rounded-lg p-4">
									<p className="text-white/40 blur-sm select-none">(555) 123-4567</p>
								</div>
							</div>
							...
							<div>
								...
								<div className="bg-white/5 backdrop-blur-sm rounded-lg p-4">
									<p className="text-white/40 blur-sm select-none">owner@example.com</p>
								</div>
							</div>
							...
							<button
								...
								disabled={isLoading}
								className="w-full bg-neon-green hover:bg-neon-green/90 text-black font-bold py-4 px-6 rounded-xl transition-all transform hover:scale-[1.02] active:scale-[0.98] disabled:opacity-50 disabled:cursor-not-allowed shadow-lg shadow-neon-green/20">
								{isLoading ? (
						...
						<div className="space-y-4 mb-6">
							...
							<div className="bg-neon-green/10 border border-neon-green/30 rounded-lg p-3">
								<p className="text-neon-green text-sm">✓ Contact information verified and unlocked</p>
							</div>
						</div>
					)}
				</div>
